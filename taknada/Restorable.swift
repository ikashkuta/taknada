...
/** All resorable components must be stateless in terms of abilty to recalculate their state fully from inner state of
...
(because of UIKit's requirements) but it mustn't own it. All components must follow this guides.
*/
// TODO: if component will conform this protocol then it's the solution for components connection problem!
protocol Restorable {
